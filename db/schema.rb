...
ActiveRecord::Schema[7.1].define(version: 2024_03_12_163803) do
  ...
  create_table "input_fields", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "example_field_id", null: false
    t.index ["example_field_id"], name: "index_input_fields_on_example_field_id"
  ...
  add_foreign_key "input_fields", "example_fields"
